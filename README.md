...
[![Go Report Card](https://goreportcard.com/badge/github.com/erajayatech/gin-swagger)](https://goreportcard.com/report/github.com/erajayatech/gin-swagger)
[![GoDoc](https://godoc.org/github.com/erajayatech/gin-swagger?status.svg)](https://godoc.org/github.com/erajayatech/gin-swagger)
...
$ swag init
```
4. Download [gin-swagger](https://github.com/erajayatech/gin-swagger) by using:
```sh
$ go get -u github.com/erajayatech/gin-swagger
$ go get -u github.com/swaggo/files
```
And import following in your code:

```go
import "github.com/erajayatech/gin-swagger" // gin-swagger middleware
...
import (
	...
	_ "github.com/erajayatech/gin-swagger/example/basic/docs" // docs is generated by Swag CLI, you have to import it.
)
